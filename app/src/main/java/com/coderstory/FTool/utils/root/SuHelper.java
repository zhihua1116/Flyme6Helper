...
public abstract class SuHelper {
    ...
    private static String TAG = "SuHelper";
    ...
    public static boolean canRunRootCommands() {
        ...
        try {
            ...
            Result = false;
            Log.e(TAG, "Root access rejected [" + e.getClass().getName() + "] : " + e.getMessage());
        }
        ...
        try {
            ...
            if (null != commands && commands.size() > 0) {
                ...
                try {
                    ...
                    Log.e(TAG, "Error executing root action:" + ex.getMessage());
                    Log.e(TAG, "Error executing root action:" + String.valueOf(ex.getCause()));
                }
            }
        } catch (IOException ex) {
            Log.e(TAG, "Can't get root access:", ex);
        } catch (Exception ex) {
            Log.e(TAG, "Error executing internal operation:", ex);
        }
        return retval;
    }
