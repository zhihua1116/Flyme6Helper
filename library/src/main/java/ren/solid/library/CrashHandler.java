...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    //用于格式化日期,作为日志文件名的一部分
    private static SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss", Locale.CHINESE);
     ...
     */
     public static int saveCrashInfo2File(Throwable ex) {
     ...
     * @return 返回文件名称, 便于将文件传送到服务器
     */
    public static int saveCrashInfo2File(String ex) {
    ...
    private static Comparator<File> newfileFinder = new Comparator<File>() {
    ...
    private static int cleanLogFileToN(String dirname) {
